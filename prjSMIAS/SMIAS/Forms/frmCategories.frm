    ...
    Select Case srcPerformWhat
        ...
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("tbl_IC_Category", "PK", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    ...
                    If ANS = vbYes Then
                        DelRecwSQL "tbl_IC_Category", "PK", "", True, CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        RefreshRecords
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "CategoryName,Description,PK"
        .Tables = "tbl_IC_Category"
        .SortOrder = "CategoryName ASC"
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsCategory, RecordPage.PageStart, RecordPage.PageEnd, 2, 2, False, True, , , , "PK")
    Me.Enabled = True
