...
Begin VB.Form frmVanCollectionAEPickFrom 
   ...
   EndProperty
   Icon            =   "frmVanCollectionAEPickFrom.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   1290
   ...
   End
End
Attribute VB_Name = "frmVanCollectionAEPickFrom"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private Sub cmdCancel_Click()
    frmVanCollectionAE.CloseMe = True
    Unload Me
End Sub
...
Private Sub cmdNext_Click()
    ...
    Else
        frmVanCollectionAE.LLFK = toNumber(nsdLastLoading.BoundText)
        Unload Me
    End If
End Sub
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
    If UnloadMode = 0 Then frmVanCollectionAE.CloseMe = True
End Sub

Private Sub Form_Unload(Cancel As Integer)
    Set frmVanCollectionAEPickFrom = Nothing
End Sub
