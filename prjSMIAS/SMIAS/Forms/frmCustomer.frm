...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmCustomerAE.State = adStateAddMode
            frmCustomerAE.show vbModal
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("tbl_AR_Customer", "PK", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    ...
                    If ANS = vbYes Then
                        DelRecwSQL "tbl_AR_Customer", "PK", "", True, CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        RefreshRecords
                        MAIN.UpdateInfoMsg
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "CustomerID, Name, Address, CityTown, Province, ZipCode, ContactPerson,Status, PK"
        .Tables = "tbl_AR_Customer"
        .SortOrder = "Name ASC"
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsCustomer, RecordPage.PageStart, RecordPage.PageEnd, 8, 2, False, True, , , , "PK")
    Me.Enabled = True
