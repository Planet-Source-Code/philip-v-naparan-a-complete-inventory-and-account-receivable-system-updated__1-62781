...
Begin VB.Form frmVanRemmitanceAEPickFrom 
   ...
   EndProperty
   Icon            =   "frmVanRemmitanceAEPickFrom.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   1290
   ...
   End
End
Attribute VB_Name = "frmVanRemmitanceAEPickFrom"
...
Private Sub cmdCancel_Click()
    frmVanRemmitanceAE.CloseMe = True
    Unload Me
End Sub
...
Private Sub cmdNext_Click()
    ...
    Else
        frmVanRemmitanceAE.LLFK = toNumber(nsdLastLoading.BoundText)
        frmVanRemmitanceAE.txtVan.Text = nsdLastLoading.getSelValueAt(3)
        frmVanRemmitanceAE.txtVan.Tag = toNumber(nsdLastLoading.getSelValueAt(4))
        Unload Me
    End If
End Sub
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
    If UnloadMode = 0 Then frmVanRemmitanceAE.CloseMe = True
End Sub

Private Sub Form_Unload(Cancel As Integer)
    Set frmVanRemmitanceAEPickFrom = Nothing
End Sub
