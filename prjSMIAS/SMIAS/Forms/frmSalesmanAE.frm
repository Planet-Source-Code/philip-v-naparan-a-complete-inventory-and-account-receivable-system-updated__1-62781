...
Private Sub DisplayForEditing()
    ...
    With rs
        txtEntry(0).Text = .Fields("SalesmanID")
        ...
        txtEntry(6).Text = .Fields("ContactNo")
        txtEntry(7).Text = .Fields("Memo")
    End With
...
Private Sub GeneratePK()
    PK = getIndex("tbl_AR_Salesman")
    txtEntry(0).Text = GenerateID(PK, "SM-", "00000")
End Sub
...
Private Sub cmdSave_Click()
    ...
    If State = adStateAddMode Or State = adStatePopupMode Then
        rs.AddNew
        rs.Fields("PK") = PK
        rs.Fields("SalesmanID") = txtEntry(0).Text
    ...
    With rs
        ...
        .Fields("ContactNo") = txtEntry(6).Text
        .Fields("Memo") = txtEntry(7).Text
...
Private Sub Form_Load()
    ...
    rs.Open "SELECT * FROM tbl_AR_Salesman WHERE PK = " & PK, CN, adOpenStatic, adLockOptimistic
