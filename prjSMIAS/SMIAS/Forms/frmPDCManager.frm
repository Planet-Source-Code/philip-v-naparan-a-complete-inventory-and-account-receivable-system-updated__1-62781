...
Begin VB.Form frmPDCManager 
   ...
   End
End
Attribute VB_Name = "frmPDCManager"
...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmPDCManagerAE.State = adStateAddMode
            frmPDCManagerAE.show vbModal
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("tbl_AR_PDCManager", "PK", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
                    MsgBox "This record has been removed by other user.Click 'OK' button to refresh the records.", vbExclamation
                    RefreshRecords
                    Exit Sub
                Else
                    With frmPDCManagerAE
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    ...
                    If ANS = vbYes Then
                        DelRecwSQL "tbl_AR_PDCManager", "PK", "", True, CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        RefreshRecords
                        MAIN.UpdateInfoMsg
        ...
        Case "Refresh"
            RefreshRecords
        Case "Print"
            frmDueChecksPrintOp.show vbModal
        Case "Close"
            Unload Me
    End Select
    Exit Sub
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "CheckNo,DateIssued,DateDue,AccountName,AccountNo,CheckAmount,BankName,Address,Cleared,Remarks,VanName,PK"
