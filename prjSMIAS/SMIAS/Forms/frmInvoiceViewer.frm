...
Begin VB.Form frmInvoiceViewer 
   ...
   End
End
Attribute VB_Name = "frmInvoiceViewer"
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "InvoiceNo,Date,SoldTo,Address,VanName,Salesman,ChargeAccount,PaymentType,BilledIn,Discount,TotalAmount,DownPayment,AmountPaid,Balance,Remarks,SoldToPK,VanFK,SalesmanFK,LastLoadingFK,PK"
        .Tables = "qry_AR_Invoice"
        .SortOrder = "PK DESC"
        .wCondition = "SoldToPK=" & CUS_PK
