...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmVanAE.State = adStateAddMode
            frmVanAE.show vbModal
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("tbl_AR_Van", "PK", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    ...
                    If ANS = vbYes Then
                        DelRecwSQL "tbl_AR_Van", "PK", "", True, CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        RefreshRecords
...
err:
        ...
        ElseIf err.Number = -2147217900 Then
            ...
            Resume
        Else
            prompt_err err, VanName, "ReloadRecords"
        End If
End Sub
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "VanName,Description,PlateNo,PK"
        .Tables = "tbl_AR_Van"
        .SortOrder = "VanName ASC"
        
        .SaveStatement
    End With
    
    rsVan.CursorLocation = adUseClient
    rsVan.Open SQLParser.SQLStatement, CN, adOpenStatic, adLockReadOnly
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsVan, RecordPage.PageStart, RecordPage.PageEnd, 3, 2, False, True, , , , "PK")
    Me.Enabled = True
