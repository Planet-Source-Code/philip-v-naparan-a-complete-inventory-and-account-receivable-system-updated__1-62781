...
Begin VB.Form frmInvoiceViewerPH 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Payment Viewer"
   ClientHeight    =   6300
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   10170
   ...
   EndProperty
   Icon            =   "frmInvoiceViewerPH.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6300
   ...
   End
End
Attribute VB_Name = "frmInvoiceViewerPH"
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "Date,InvoiceNo,CustomerName,PaymentType,Amount,Balance,Remarks,VCFK,InvoiceFK,PK"
        .Tables = "qry_AR_VanCollectionDetails"
        .SortOrder = "PK DESC"
        .wCondition = "InvoiceFK=" & INV_PK
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsStocks, RecordPage.PageStart, RecordPage.PageEnd, 7, 2, False, True, , , , "PK")
    Me.Enabled = True
...
Private Sub Form_Unload(Cancel As Integer)
    Set frmInvoiceViewerPH = Nothing
End Sub
