...
Begin VB.Form frmCustomerWB 
   ...
   End
End
Attribute VB_Name = "frmCustomerWB"
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "CustomerID, Name, Address, ContactPerson,Balance,VanName, PK"
        .Tables = "qry_AR_CustomerWB"
        .wCondition = "Balance>0"
        .SortOrder = "Balance DESC,Name ASC"
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsCustomer, RecordPage.PageStart, RecordPage.PageEnd, 7, 2, False, True, , , , "PK")
    Me.Enabled = True
