...
Begin VB.Form frmNCustomer 
   Caption         =   "New Customer Records"
   ClientHeight    =   7155
   ClientLeft      =   60
   ClientTop       =   240
   ClientWidth     =   9000
   ...
   End
End
Attribute VB_Name = "frmNCustomer"
...
Private Sub Form_Activate()
    HighlightInWin Me.Name: MAIN.ShowTBButton "fftfttt"
End Sub
